...
class Administrador extends Controller
{
    ...
    {
        parent::__construct();
        BackendMenu::setContext('Tresfera.Buildyouup', 'buildyouup', 'administrador');
    ...
    public function onGenerateRapports() {
        ...
        foreach($ids as $id) {
            ...
            $evaluacion->save();
            Queue::push('\Tresfera\Buildyouup\Classes\Jobs\GenerateRapport',$id,"rapports");
        }
    ...
    public function onDownloadRapports() {
        ...
        Queue::push('\Tresfera\Buildyouup\Classes\Jobs\SendRapport',$ids,"sendrapports");
    ...
    {
        Queue::push('\Tresfera\Buildyouup\Classes\Jobs\ExportResultAnswer',[],"exportdatosbrutos");
    ...
    public function onSendEmailRecordatorioAsignacion()
    {
        ...
        foreach($ids as $id)
        {
            ...
            {
                Queue::push('\Tresfera\Buildyouup\Classes\Jobs\SendRecordatorioAsignacion',$id,"sendemailasignacion");
            }
        }
        \Flash::success("Hemos enviado los correos de recordatorio de asignación a los usuarios seleccionados que no aun han asignado ningún evaluador.");
        return \Redirect::to("/backend/tresfera/buildyouup/administrador");
