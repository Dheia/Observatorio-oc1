...
class BuilderTableCreateTresferaBuildyouupAnswers extends Migration
{
    public function up()
    {
        Schema::create('tresfera_buildyouup_answers', function($table)
        {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('tresfera_buildyouup_answers');
    }
}
