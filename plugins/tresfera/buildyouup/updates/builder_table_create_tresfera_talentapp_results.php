...
class BuilderTableCreateTresferaBuildyouupResults extends Migration
{
    public function up()
    {
        Schema::create('tresfera_buildyouup_results', function($table)
        {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('tresfera_buildyouup_results');
    }
}
