...
class Result extends \Tresfera\Taketsystem\Models\Result
{
     ...
     */
    public $table = 'tresfera_talentapp_results';

    public $hasMany = [
      'answers'  => ['Tresfera\Talentapp\Models\Answer'],
    ];
    ...
    public function getTotals()
    {
        return $this->addSelect(DB::raw('count(distinct result_id) as numQuizz'))
                    ...
                    ->join('tresfera_talentapp_answers', 'tresfera_talentapp_results.id', '=', 'tresfera_talentapp_answers.result_id')
                    ->get();
    }
}
