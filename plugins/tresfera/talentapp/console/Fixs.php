...
class Fixs extends Command
{
    ...
    {
        $results = \Tresfera\Taketsystem\Models\Result::all();
        foreach($results as $result) {
            if($result->import) continue;
            $evaluacion = \Tresfera\Talentapp\Models\Evaluacion::find($result->evaluacion_id);
