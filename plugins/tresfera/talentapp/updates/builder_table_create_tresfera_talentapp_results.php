...
class BuilderTableCreateTresferaTalentappResults extends Migration
{
    public function up()
    {
        Schema::create('tresfera_talentapp_results', function($table)
        {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('tresfera_talentapp_results');
    }
}
