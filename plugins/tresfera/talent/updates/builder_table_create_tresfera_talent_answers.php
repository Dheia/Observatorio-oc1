...
class BuilderTableCreateTresferaTalentAnswers extends Migration
{
    public function up()
    {
        Schema::create('tresfera_talent_answers', function($table)
        {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('tresfera_talent_answers');
    }
}