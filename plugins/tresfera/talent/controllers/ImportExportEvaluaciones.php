...
class ImportExportEvaluaciones extends ImportExportController
{
    ...
    public function exportFromList($definition = null, $options = [])
    {
        ...
        */
        ...
        $estadisticas = Proyecto::getEstadisticas("tresfera_talentapp-Administrador_CSV-Filter-listFilter");

        $csv->insertOne("TalentApp360");
        ...
        $csv->insertOne("Evaluados finalizados: ".$estadisticas['evaluados_activos'] );
        $csv->insertOne("Proyectos finalizados: ".$estadisticas['proyectos_finalizados'] );
       // $csv->insertOne("Evaluaciones completadas: ".$estadisticas['evaluaciones_completadas']);
        //$csv->insertOne("Evaluaciones pendientes: ".$estadisticas['evaluaciones_pendientes']);
