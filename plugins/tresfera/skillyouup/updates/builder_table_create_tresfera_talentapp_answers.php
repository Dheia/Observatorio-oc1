...
class BuilderTableCreateTresferaSkillyouupAnswers extends Migration
{
    public function up()
    {
        Schema::create('tresfera_skillyouup_answers', function($table)
        {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('tresfera_skillyouup_answers');
    }
}
