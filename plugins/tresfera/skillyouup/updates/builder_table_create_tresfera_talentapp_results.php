...
class BuilderTableCreateTresferaSkillyouupResults extends Migration
{
    public function up()
    {
        Schema::create('tresfera_skillyouup_results', function($table)
        {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('tresfera_skillyouup_results');
    }
}
