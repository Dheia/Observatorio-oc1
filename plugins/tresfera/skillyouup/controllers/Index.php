...
class Index extends Controller
{
    ...
    public function onConsentimiento() {
        if(post('consentimiento')) {
            ...
            $this->user->save();
            \Flash::success(e(trans('tresfera.skillyouup::lang.evaluadores.bienvenido')));
        } else {
            \Flash::error(e(trans('tresfera.skillyouup::lang.evaluadores.lopd_error')));
        }
        return Redirect::to("/backend/tresfera/skillyouup/index/");
    }
/*
